  ...
  return (
    ...
    className='w-full h-screen bg-gradient-to-b from-black
     to-gray-800 p-4 text-white'>
        ...
        max-w-screen-lg mx-auto h-full pt-20'>
            <div className='pb-8'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/31cd9a2f-5abd-4de7-9b15-a7073a996e96" 
                method = 'POST'
                className='flex flex-col w-full md:w-1/2'>
                    ...
                    items-center rounded-md hover:scale-110 duartion-300'
                    >Let's Talk 
                    </button>
                </form>
            </div>
